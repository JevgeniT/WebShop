        ...
        <#if productslist?has_content>
            <#list productslist as product>
                <tr>
                    ...
                    <td>${product.getQuantity()?cap_first}</td>
                    <td>
                        <div class="dropdown">
                                <button class="btn btn-secondary btn-sm dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Edit</button>
                                <form class="dropdown-menu p-4" aria-labelledby="dropdownMenu2" action="/admin/product/edit/${product.getId()}" method="post" id="newProduct">
                    ...
                    <td><a href="/admin/product/delete/${product.getId()}" class="btn btn-info btn-sm">Delete</a></td>
                </tr>
            </#list>
        </#if>
        </tbody>
